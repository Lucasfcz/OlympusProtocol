    ...
    <div className="h-full flex flex-col bg-surface text-fg anim-slide">
      ...
      <div className="flex-1 overflow-y-auto olympus-scroll pb-5">
        <section className="px-5 mt-6">
          ...
          <p className="text-xs text-fg-muted mt-1">4ª série de 4</p>
        </section>
        ...
        <section className="px-5 mt-7">
          <p className="label-caps text-fg-muted">RPE (opcional)</p>
              ...
              return (
                <button
                  ...
                  className={`flex-1 rounded-sm anim-seg origin-bottom ${
                    active ? "bg-gold" : "bg-card border border-gold/20"
                  }`}
            ...
            <ul className="mt-3 divide-y divide-divider">
              {setHistory.map((s) => (
                <li key={s.n} className="grid grid-cols-3 py-3 text-sm">
                  <span className="text-fg-muted">{s.n}ª série</span>
                  <span>{s.reps} reps</span>
                  <span className="text-right">{s.kg} kg</span>
                </li>
              ))}
            </ul>
          </div>
