  ...
  return (
    <div className="bg-surface text-fg px-5 pt-6 pb-5 anim-fade">
      <header className="flex items-center justify-between">
        <button className="btn-press"><Menu size={22} strokeWidth={1.6} /></button>
      ...
      <div className="mt-7">
        <p className="label-caps text-fg-muted">BOM DIA,</p>
      ...
      <section className="card mt-6 p-5">
        ...
        <div className="flex items-center justify-between mt-2">
          <div>
            <div className="text-5xl font-bold tracking-tight">92<span className="text-gold">%</span></div>
      ...
      <section className="card mt-4 p-5">
        <p className="label-caps text-fg-muted">PRÓXIMO TREINO</p>
        <div className="flex items-center justify-between mt-2">
          <div>
            <h2 className="text-xl font-semibold mt-1">Costas e Bíceps</h2>
            <p className="text-xs text-fg-muted mt-1">Hoje &middot; 18:00</p>
          </div>
      ...
      <section className="card mt-4 p-5">
        <p className="label-caps text-fg-muted">RESUMO SEMANAL</p>
